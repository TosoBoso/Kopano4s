#!/bin/sh
# (c) 2018-19 vbettag - wraper script for kopano-folderlist in Docker container
...
echo -e "\n" | $SUDO docker exec -i kopano4s /usr/share/z-push/backend/kopano/listfolders.php "$@" 2>&1
